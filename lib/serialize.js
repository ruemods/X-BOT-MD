...
///////////////ALWAYS ONLINE
ALWAYS_ONLINE ? client.sendPresenceUpdate("available", m.user) : client.sendPresenceUpdate("unavailable", m.user)
//////////////////////
...
m.sendMsg = async(jid, content, opt = {
  ...
  // var { body , footer , header , buttons } = content 
    ...
    /*
   const optional = generateWAMessageFromContent(jid,
                                                {
    viewOnceMessage: {
      message: {
        messageContextInfo: {
        ...
        interactiveMessage: proto.Message.InteractiveMessage.create({
          body: proto.Message.InteractiveMessage.Body.create({ body : content }),
          footer: proto.Message.InteractiveMessage.Footer.create({ footer : opt.footer || "" }),
          header: proto.Message.InteractiveMessage.Header.create({ header : opt.header || "" }),
          nativeFlowMessage:
...
*/
 ...
 return await client.relayMessage(jid, msg.message, {
    messageId: msg,
  });
